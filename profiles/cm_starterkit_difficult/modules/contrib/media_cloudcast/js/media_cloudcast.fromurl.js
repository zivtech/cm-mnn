...
/**
 *  @file
 *  Create the 'Cloudcast' tab for the WYSIWYG plugins.
 */

// (function ($) {
//   namespace('Drupal.media.browser.plugin');
//
//   Drupal.media.browser.plugin.media_cloudcast = function(mediaBrowser, options) {
//     return {
//       init: function() {
//         tabset = mediaBrowser.getTabset();
//         tabset.tabs('add', '#media_cloudcast', 'Cloudcast');
//         mediaBrowser.listen('tabs.show', function (e, id) {
//           if (id == 'media_cloudcast') {
//             // We only need to set this once.
//             // We probably could set it upon load.
//             if (mediaBrowser.getActivePanel().html() == '') {
//               mediaBrowser.getActivePanel().html(options.media_cloudcast);
//             }
//           }
//         });
//       }
...
//   //@todo: needs a review.
//   Drupal.media.browser.register('media_cloudcast', Drupal.media.browser.plugin.media_cloudcast, {});
// })(jQuery);

(function ($) {
  namespace('media.browser.plugin');

  Drupal.media.browser.plugin.cloudcast_library = function(mediaBrowser, options) {

    return {
      mediaFiles: [],
      init: function() {
        tabset = mediaBrowser.getTabset();
        tabset.tabs('add', '#cloudcast_library', 'Cloudcast');
        var that = this;
        mediaBrowser.listen('tabs.show', function (e, id) {
          if (id == 'cloudcast_library') {
  ...
  Drupal.media.browser.register('cloudcast_library', Drupal.media.browser.plugin.cloudcast_library);
})(jQuery);
