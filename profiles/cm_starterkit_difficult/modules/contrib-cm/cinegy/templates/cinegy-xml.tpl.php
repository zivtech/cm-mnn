...
?>
 <program name="<?php print check_plain($node->title) ?>"><guid><?php print getGUID()?></guid><block name="Block 1"><guid><?php print getGUID()?></guid><item name="<?php print '(' . check_plain($node->field_program_code[LANGUAGE_NONE][0]['value']) . $node->field_filformat[LANGUAGE_NONE][0]['value'] . ') ' . check_plain($node->title) ?>" src_in="00:00:00:00" src_out="<?php print cinegy_sec2hms($node->field_okv_duration[LANGUAGE_NONE][0]['value']) ?>:00" in="00:00:00:00" out="<?php print cinegy_sec2hms($node->field_okv_duration[LANGUAGE_NONE][0]['value']) ?>:00" type="clip" flags="0x10" split_audio="0" start="<?php print $start_time ?>" date="<?php print $start_date ?>"><guid><?php print getGUID()?></guid><FrameRate>25</FrameRate><timeline duration="<?php print $accumulated_duration ?>">
